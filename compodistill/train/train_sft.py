...
def train():
    ...
    if model_arguments.post_connector_use :
        ...
        pcn_dir = "Distilled_Fine-Tuned_Model_Path"
    ...
    if ((not distill_arguments.pretrain_distill) and (training_arguments.tune_type_llm.lower() == "frozen")) or (distill_arguments.final_sft) :
        del teacher_model
        del trainer.teacher_model
        trainer.teacher_model = None
        torch.cuda.empty_cache()
        print("NOTICE : Removed Teacher Model -> SFT Mode")
