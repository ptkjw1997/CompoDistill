...
class DistillArguments:
    ...
    use_attn_loss: Optional[bool] = field(default = False)

    pretrain_distill: Optional[bool] = field(default=True)
    final_sft: Optional[bool] = field(default=False)
